package com.li.test.drools.rules.complexProblem;
...
public class GolferProblem {
	 ...
	 * 我们将最左边的位置定为1，最右边的位置定为4，中间依次是2,3位置。 现在我们了解的情况是： 1.高尔夫球员Fred,目前不知道他的位置和衣服颜色
	 * 2.Fred右边紧挨着的球员穿蓝色衣服 3.Joe排在第2个位置 4.Bob穿着格子短裤 5.Tom没有排在第1位或第4位，也没有穿橙色衣服
	 * 请问,这四名球员的位置和衣服颜色。
	 */
